...
public class ProcessSimulator {
 ...
 /* la politica de planificacion fifo*/
    public void fifo() {
 ...
 /* la politica de planificacion spn*/
    public void spn(){
        int n = np - 1;
        int j = ini[0];
        int tope = j;
            ...
            if (a > 0) {
                ...
                for (x = 0; x <= n; ++x) {
                    ...
                    if (ejec[x] == 1) {
                       ...
                       /* 
                        if(prio[x] >= temp[x]){
                            prio[x] = (float) (tespera[x] + cpu[x]) / (float) cpu[x-1] ;        
                            temp[x] = (int) prio[x];
 ...
 /* la politica de planificacion rr*/   
    public void rr() {
        boolean su = false;
        int s = 1;
        int u = 0;
 ...
 /* la politica de planificacion hrn*/
    public void hrn() {
        int n = np - 1;
        int j = ini[0];
        int tope = j;
    ...
    public void calcularTEI() {
        ...
        for (int i = 0; i < np; ++i) {
            ...
            suma_e += T[i];
            suma_i += E[i];
            //System.out.println("el suma es: "+suma_e);
            
            
        }
        promedio_e = suma_e / np;
        promedio_i = suma_i / np;
        
        System.out.println("==================================================");
        System.out.println("el promedio de tiemmpo de retorno es: "+promedio_e);
        System.out.println("el promedio de tiempo de espera es: "+promedio_i);
        System.out.println("===================================================");
    }
